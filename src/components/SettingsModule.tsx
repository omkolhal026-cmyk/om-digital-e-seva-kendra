  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-4 text-slate-900">
        ...
        <p className="text-xs text-slate-500 font-medium">
          Your data is automatically saved locally in <code className="bg-slate-100 px-1 py-0.5 rounded text-slate-800 font-mono">om_seva_database.json</code> and synced to your connected Google Sheet.
        </p>
        ...
        <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-2xl text-xs text-emerald-950 space-y-3">
          ...
          <p className="text-slate-600 font-medium">
            टीप: नवीन नोंदी तुमच्या सर्व्हरवर (<code className="bg-emerald-100/70 px-1 py-0.5 rounded text-emerald-900 font-mono">om_seva_database.json</code>) कायमस्वरूपी सुरक्षित राहतात. गुगल शीटमध्ये सेव्ह करण्यासाठी वरील बटणावर क्लिक करा.
          </p>
        </div>
