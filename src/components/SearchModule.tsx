                  ...
                  {item.type === 'registration' && (
                    <>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-slate-900">{(item.raw as WorkerRegistration).aadhaarNumber}</span>
                      </div>
                      <div className="flex justify-between">
            ...
            <div className="flex items-center gap-4 mb-5 pb-4 border-b border-slate-200">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500 font-medium mt-0.5">
                  Record ID: {selectedResult.id} • Date: {selectedResult.date}
                </div>
              </div>
            </div>
            ...
            {selectedResult.type === 'registration' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs mb-6">
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2 text-slate-800">
                  ...
                  <div><span className="text-slate-500 font-medium">Father/Husband:</span> <span className="font-semibold">{(selectedResult.raw as WorkerRegistration).fatherName}</span></div>
                  <div><span className="text-slate-500 font-medium">DOB & Gender:</span> <span className="font-semibold">{(selectedResult.raw as WorkerRegistration).dob} ({(selectedResult.raw as WorkerRegistration).gender})</span></div>
                  ...
                  <div><span className="text-slate-500 font-medium">Aadhaar:</span> <span className="font-mono font-semibold">{(selectedResult.raw as WorkerRegistration).aadhaarNumber}</span></div>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2 text-slate-800">
                  ...
                  <div><span className="text-slate-500 font-medium">Bank Name:</span> <span className="font-semibold">{(selectedResult.raw as WorkerRegistration).bankName}</span></div>
                  <div><span className="text-slate-500 font-medium">Account No:</span> <span className="font-mono font-semibold">{(selectedResult.raw as WorkerRegistration).accountNumber}</span></div>
                  <div><span className="text-slate-500 font-medium">IFSC:</span> <span className="font-mono font-semibold">{(selectedResult.raw as WorkerRegistration).ifsc}</span></div>
            ...
            {selectedResult.type === 'renewal' && (
              <div className="p-4 rounded-2xl bg-purple-50/60 border border-purple-200 text-xs mb-6 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-slate-800">
                  ...
                  <div><span className="text-slate-500">New Valid Till:</span> <span className="font-bold text-emerald-800">{(selectedResult.raw as WorkerRenewal).validTill}</span></div>
            ...
            {selectedResult.type === 'claim' && (
              <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-200 text-xs mb-6 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-slate-800">
                  ...
                  <div><span className="text-slate-500">Application Date:</span> <span className="font-semibold">{selectedResult.date}</span></div>
                  ...
                  <div className="space-y-1.5">
                    {linkedRenewals.map((r) => (
                      <div key={r.id} className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 flex justify-between text-xs">
                        <div>
                          <span className="font-bold text-slate-900">{r.id}</span> • {r.renewalPeriodYears} Year Renewal ({r.renewalDate})
                        </div>
